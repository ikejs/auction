      ...
      <nav className="navbar navbar-custom navbar-static-top bg-white">
        <div className="row">
          <div className="col-xs-12 d-flex justify-content-center">
            <img className="col-md-6 align-self-center" src="/images/salvation-army.png" style={{ maxHeight: "100px" }} />
            <img className="col-md-6 align-self-center" src="/images/ski-brule.png" style={{ maxHeight: "100px" }} />
